...
from agentic_discord_moderation_bot.utils.tools import get_user_history, get_context, create_invite, wikipedia_query_tool, ddg_tool


class Query(commands.Cog):
    def __init__(self, bot: AgentBot):
        self.bot = bot
        self.tools = [get_user_history, get_context, create_invite, wikipedia_query_tool, ddg_tool]
